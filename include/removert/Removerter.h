...
private:
    ...
    std::vector<pcl::PointCloud<PointType>::Ptr> scans_origin_;
    ...
    pcl::PointCloud<PointType>::Ptr submap_static;
    pcl::PointCloud<PointType>::Ptr submap_dynamic;
